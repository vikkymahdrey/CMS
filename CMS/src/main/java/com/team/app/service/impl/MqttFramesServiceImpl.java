...
public class MqttFramesServiceImpl implements MqttFramesService {
	...
	public List<LoraFrame> devEUIGroupBy() throws Exception {
		return frmaeDao.devEUIGroupBy();
	}



	
	public List<LoraFrame> getFrameByDevEUI(String devEUI) throws Exception {
		return frmaeDao.getFrameByDevEUI(devEUI);
	}
